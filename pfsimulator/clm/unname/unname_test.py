...
CONCN.ComputationalGrid.NX = 252
CONCN.ComputationalGrid.NY = 146
...
#
CONCN.Geom.domain.Upper.X = 252*961.72
CONCN.Geom.domain.Upper.Y = 146*961.72
...
#CONCN.ICPressure.Type                                   = 'HydroStaticPatch'
#CONCN.ICPressure.GeomNames                              = 'domain'
#CONCN.Geom.domain.ICPressure.Value                      = -0.001
#CONCN.Geom.domain.ICPressure.RefGeom                    = 'domain'
#CONCN.Geom.domain.ICPressure.RefPatch                   = 'z_upper'
